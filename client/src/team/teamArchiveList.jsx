...
export default function TeamArchive() {
  ...
  useEffect(() => {
    const fetchArchivedTeams = async () => {
      try {
        ...
        const response = await fetch('https://lavoro-back.onrender.com/teams/archived-teams', {
          headers: {
            'Authorization': `Bearer ${token}`
          },
  ...
  const handleUnarchive = async (teamId) => {
    try {
      const response = await fetch(`https://lavoro-back.onrender.com/teams/unarchive/${teamId}`, {
        method: 'POST',
        headers: {
  ...
  const handleDelete = async (teamId) => {
    ...
    if (result.isConfirmed) {
      try {
        ...
        const response = await fetch(`https://lavoro-back.onrender.com/teams/delete-archived-team/${teamId}`, {
          method: 'DELETE',
          headers: {
            'Authorization': `Bearer ${token}`,
